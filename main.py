...
def main_page():
    ...
    def timeflight():
            ...
            image = Image.open("airplane-logo2.png")
            photo = ImageTk.PhotoImage(image)
    ...
    image = Image.open("background_img.jpg")
    photo = ImageTk.PhotoImage(image)
...
image = Image.open("start_page.png")
photo = ImageTk.PhotoImage(image)
label = Label(image=photo)
label.image=photo
